...
var testInsult = [
  `Hello ${mention}, how are you today?`
]

// Generate an insult
function genInsult (mention, callback) {
  util.randomInt(0, testInsult.length, function (result) {
    // TODO return a finished insult with the mention included
  })
}

// Export all the things
module.exports.testInsult = testInsult
